...
<jsp:useBean id="dao" class="com.sist.dao.FoodDAO"></jsp:useBean>   
 ...
 <%
 	...
 	/*
 		서울시 종로구 북촌로 6-8 지번 서울시 종로구 재동 85-1
 		    ㅣ----- 구를 잘라내기
 		    첫번째 공백 자르기
 		    addr1 :서울시 종로구 북촌로 6-8
 		    temp :종로구 북촌로 6-8
 		    addr3:종로구  
 	*/
...
<script type="text/javascript" src="//dapi.kakao.com/v2/maps/sdk.js?appkey=c8888e08fc45217dd59f5f2ec124656b&libraries=services"></script>
</head>
<body>
<%--

	#{변수명} => getter : get method
	${변수명} => 일반 변수
